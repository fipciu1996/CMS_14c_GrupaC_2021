...
function refined_magazine_scripts()
{
    ...
    /*Sticky Sidebar*/
    if(!empty($refined_magazine_theme_options['refined-magazine-enable-sticky-sidebar']) && absint($refined_magazine_theme_options['refined-magazine-enable-sticky-sidebar']) == 1) {
